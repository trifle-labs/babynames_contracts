...
contract MerkleWhitelistTest is TestHelpers {
    ...
    function test_ValidProof_CreateCategory() public {
        ...
        uint256 catId = market.createCategory(
            2025, 1, 0, BabyNameMarket.Gender.Female, names, block.timestamp + 30 days, nameProofs
        );
        assertEq(catId, 1);
    }
    ...
    function test_InvalidProof_CreateCategory() public {
        ...
        vm.expectRevert(BabyNameMarket.InvalidNameProof.selector);
    ...
    function test_ValidProof_AddNameToCategory() public {
        ...
        uint256 catId = market.createCategory(
            2025, 1, 0, BabyNameMarket.Gender.Female, names, block.timestamp + 30 days, _getProofs(names)
        );
    ...
    function test_ExactaTrifecta_SkipsValidation() public {
        ...
        uint256 catId = market.createCategory(
            2025, 12, 1, BabyNameMarket.Gender.Female, names, block.timestamp + 30 days, _emptyProofs()
        );
        assertGt(catId, 0);
        ...
        uint256 catId2 = market.createCategory(
            2025, 123, 2, BabyNameMarket.Gender.Female, triNames, block.timestamp + 30 days, _emptyProofs()
        );
        assertGt(catId2, 0);
    }
    ...
    function test_TopN_ValidatesNames() public {
        ...
        uint256 catId = market.createCategory(
            2025, 3, 3, BabyNameMarket.Gender.Female, names, block.timestamp + 30 days, _getProofs(names)
        );
        assertGt(catId, 0);
        ...
        vm.expectRevert(BabyNameMarket.InvalidNameProof.selector);
        market.createCategory(
            2025, 3, 3, BabyNameMarket.Gender.Female, badNames, block.timestamp + 30 days, badProofs
        );
    }
