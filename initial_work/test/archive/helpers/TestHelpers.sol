...
import "../../../src/archive/BabyNameMarketCurve.sol";
...
abstract contract TestHelpers is Test {
    BabyNameMarketCurve public market;
    ...
    function setUp() public virtual {
        ...
        vm.prank(owner);
        market = new BabyNameMarketCurve(resolver, address(token));
    ...
    function _createTestCategory() internal returns (uint256) {
        ...
        return market.createCategory(
            ...
            1,
            0, // CAT_SINGLE
            BabyNameMarketCurve.Gender.Female,
            names,
    ...
    function _createTestCategoryMale() internal returns (uint256) {
        ...
        return market.createCategory(
            ...
            1,
            0, // CAT_SINGLE
            BabyNameMarketCurve.Gender.Male,
            names,
            block.timestamp + DEFAULT_DEADLINE_OFFSET,
            _emptyProofs()
        );
